...
class AgentMixin:
    ...
    def call_openai_with_schema(
        ...
        """
        Attempt to complete the given prompts and parse the response into the
        given schema. If there are network errors, retry up to max_retries
        ...
        schema_class
            The schema into which the response will be parsed.
        ...
        -------
        schema_class
            An instance of the schema populated with the results of the call.
        """
        retries = 0
        model = "gpt-5-mini"
        while retries < max_retries:
